...
import no.ndla.conceptapi.ComponentRegistry.{conceptSearchService, readService, writeService, user}
...
/*
This is just to share endpoints between controller while frontend migration is ongoing.
TODO: Move these to [[DraftConceptController]] and delete this file when frontend starts using [[DraftConceptController]] instead of [[PublishedConceptController]]
 */
abstract class DraftNdlaController() extends NdlaController {
  get(
    "/tags/",
    operation(
